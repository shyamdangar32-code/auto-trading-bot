...
def main():
    ...
    p.add_argument("--use_block", default="", help="optional label echoed in outputs")
    # frictions passthrough (optional)
    ...
    cfg.setdefault("backtest", {}).setdefault("profile", args.profile)
    ...
    if args.use_block: print(f"📦 Using profile/block: {args.use_block}")

    # run backtest (engine returns 3 objects)
